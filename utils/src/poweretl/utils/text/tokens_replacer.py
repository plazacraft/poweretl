...
class TokensReplacer:
    ...
    Attributes:
        re_start (str): The starting delimiter for tokens (regex).
            Default is "{".
        re_end (str): The ending delimiter for tokens (regex).
            Default is "}".
        re_escape (str): The escape character for tokens (regex).
            Default is "\\".
    """
