...
from poweretl.databricks.helpers.session_utils import *  # noqa: F403, F401, E501 # pylint: disable=W0401, W0614
...
def databricks_session():
    ...
    global dbutils  # noqa: F824, # pylint: disable=W0603
...
def storage_provider(databricks_session):
    ...
    return DbxVolumeFileStorageProvider(
        databricks_session.spark, databricks_session.dbutils
    )
...
def test_dbx_volume_file_storage_provider_int(storage_provider, test_volume_setup):
    ...
    first_file, is_dir = storage_provider.get_first_file_or_folder(
        test_path, ascending=True
    )
